...
games.music.load("eyeofthetiger.mp3")
games.music.play(-1)
class tankone(games.Sprite):
    """Player one's tank"""
    pic=games.load_image("tank1.png")
...
class tanktwo(games.Sprite):
    """Player two's tank"""
    pic=games.load_image("tank2.png")
    def __init__(self, x, y):
...
class midwall(games.Sprite):
    ...
    pic=games.load_image("vertwall.png", transparent=False)
    def __init__(self, x, y):
        """Creates wall"""
...
class leftwall(games.Sprite):
    """Wall on the left"""
    pic=games.load_image("leftwall.png", transparent=False)
...
class rightwall(games.Sprite):
    """Wall on the right"""
    pic=games.load_image("rightwall.png", transparent=False)
    def __init__(self, x, y, mid):
...
class teleporter(games.Sprite):
    ...
    pic=games.load_image("teleporter.png")
    def __init__(self, x, y):
        """Creates teleporter"""
