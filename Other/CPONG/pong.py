...
games.init(screen_width=1200, screen_height=800, fps=100)

class pong2(games.Sprite):
    """making the pong ball sprite."""
    bball=games.load_image("bball.png")
    bball2=games.load_image("bball2.png")
    bball3=games.load_image("bball3.png")
    bball4=games.load_image("bball4.png")
    zeus=games.load_image("zeus.png")
...
class paddle(games.Sprite):
    ...
    paddle2=games.load_image("paddle.png")
...
back=games.load_image("background.png")
