...
class flier(games.Sprite):
    ...
    pic=games.load_image(os.getcwd()+"\\files\\"+"\\FlitePath\\"+"flier.png")
    shieldedpic=games.load_image(os.getcwd()+"\\files\\"+"\\FlitePath\\"+"shielded.png")
...
class block(games.Sprite):
    """Wall of the canyon"""
    pic=games.load_image(os.getcwd()+"\\files\\"+"\\FlitePath\\"+"block.png", transparent=False)
    def __init__(self, x, y):
        """creates block"""
...
class shield(games.Sprite):
    """Shield powerup"""
    pic=games.load_image(os.getcwd()+"\\files\\"+"\\FlitePath\\"+"shield.png")
    def __init__(self, x, y):
        """Creates shield"""
...
class point(games.Sprite):
    """Point bonus powerup"""
    pic=games.load_image(os.getcwd()+"\\files\\"+"\\FlitePath\\"+"plus.png")
    def __init__(self, x, y):
        """Creates powerup"""
...
class devastation(games.Sprite):
    ...
    pic=games.load_image(os.getcwd()+"\\files\\"+"\\FlitePath\\"+"BANKRUPT.png")
    def __init__(self, x, y):
        """Creates powerdown"""
...
class walls(games.Sprite):
    """Walls of the canyon"""
    pic=games.load_image(os.getcwd()+"\\files\\"+"\\FlitePath\\"+"block.png")
    def __init__(self):
        """Creates walls"""
