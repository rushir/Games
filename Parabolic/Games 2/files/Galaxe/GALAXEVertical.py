...
class shipgun(games.Sprite):
    ...
    pic=games.load_image(os.getcwd()+"\\files\\"+"\\Galaxe\\"+"shipgun.png")
...
class alien(games.Sprite):
    ...
    pic=games.load_image(os.getcwd()+"\\files\\"+"\\Galaxe\\"+"alien.png")
    total = 0
...
class aliengun(games.Sprite):
    ...
    pic=games.load_image(os.getcwd()+"\\files\\"+"\\Galaxe\\"+"aliengun.png")
...
class fleet(games.Sprite):
    ...
    pic=games.load_image(os.getcwd()+"\\files\\"+"\\Galaxe\\"+"fleet.png")
    def __init__(self):
